...
import { PayrollListPage } from 'pages/payrolls';
import { VacationListPage } from 'pages/vacations';
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                ...
                <FormListItem
                  label="Date Of Birth"
                  text={
                    data?.date_of_birth ? format(parseISO(data?.date_of_birth as unknown as string), 'dd-MM-yyyy') : ''
                  }
                />
